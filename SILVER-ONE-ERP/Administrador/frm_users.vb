...
Public Class frm_users
    ...
    Sub LIST_USER_TYPE()
        Try
            ...
            With CB_TYPE
                .DataSource = DataT
                .ValueMember = "ID_USER_TYPE"
                .DisplayMember = "US_T_NAME_USER"
            End With
        Catch ex As Exception
            XtraMessageBox.Show(ex.Message, "ERROR", MessageBoxButtons.OK, MessageBoxIcon.Error)
        Finally
    ...
    Sub LIST_FOLIOS_DISTINCT()
        Try
            ...
            With CB_SERIE
                ...
                .DisplayMember = "FO_NAME_SERIE_FOLIO"
            End With
        Catch ex As Exception
            XtraMessageBox.Show(ex.Message, "ERROR", MessageBoxButtons.OK, MessageBoxIcon.Error)
        Finally
    ...
    Private Sub BTN_SAVE_ItemClick(sender As Object, e As DevExpress.XtraBars.ItemClickEventArgs) Handles BTN_SAVE.ItemClick
        ...
        Else
            Try
                ...
                With Command
                    .Parameters.Add("@ID_USER_TYPE", SqlDbType.Int).Value = CB_TYPE.SelectedValue
                    .Parameters.Add("@ID_AGENTS", SqlDbType.Int).Value = CB_CLIENT.SelectedValue
                    .Parameters.Add("@ID_FOLIOS", SqlDbType.Int).Value = CB_SERIE.SelectedValue
                    .Parameters.Add("@US_NAME", SqlDbType.NVarChar, 200).Value = TXT_NAME.Text
                    .Parameters.Add("@US_USERNAME", SqlDbType.NVarChar, 50).Value = TXT_USERNAME.Text
                    .Parameters.Add("@US_PASSWORD", SqlDbType.NVarChar, 100).Value = TXT_PASSWORD.Text
