...
Public Class frm_user_type
    ...
    Private Sub BTN_SAVE_ItemClick(sender As Object, e As DevExpress.XtraBars.ItemClickEventArgs)
        ...
        Else
            ...
            Else
                Try
                    ...
                    With Command
                        .Parameters.Add("@ID_USER_TYPE", SqlDbType.Int).Value = TXT_ID.Text
                        .Parameters.Add("@US_T_NAME_USER", SqlDbType.NVarChar, 100).Value = TXT_NAME.Text
